...
import com.example.hotel.Adapters.Rec_HotelsAdapter;
import com.example.hotel.Adapters.SliderAdapter;
import com.example.hotel.Decoration.GridSpacingItemDecoration;
import com.example.hotel.Util.Bookings;
import com.example.hotel.Util.CurrentUser;
import com.example.hotel.Util.Drafts;
import com.example.hotel.Util.Hotel;
import com.example.hotel.Util.HotelView;
import com.example.hotel.Util.Reader;
import com.example.hotel.Util.Writer;
...
public class HotelViewer extends AppCompatActivity {
    ...
    public void setValues(String hotelName, Context context){
        ...
        TextView viewtitle , viewlocation , viewrating , viewfeature , viewcontact,viewcnt;
